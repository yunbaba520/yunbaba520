...
onMounted(() => {
  let canvasEl = document.getElementById('tutorial') as HTMLCanvasElement
  if (!canvasEl.getContext) {
    return
  }
  let ctx = canvasEl.getContext('2d') as CanvasRenderingContext2D // 2d | webgl
  ...
  function drawHours(hours: number, minute: number, second: number) {
    ctx.save()
